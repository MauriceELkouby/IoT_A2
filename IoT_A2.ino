...
#define SENSOR_PIN  17 // ESP32 -> temperature sensor DS18B20
...
const char* mqtt_topic = "water/temp";  // MQTT topic to publish messages
...
OneWire oneWire(SENSOR_PIN);//usage of this temperature sensor's class
